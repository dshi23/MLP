...
def main(args):
    ...
    # train the model
    model,train_loss, train_acc, val_loss, val_acc, earlyStop = train(model, x_train, y_train, x_valid, y_valid, config)
    ...
    plots(train_loss, train_acc, val_loss, val_acc, earlyStop)
